...
export const apiSlice = createApi({
  ...
  tagTypes: ['User', 'Patient', 'Clinical', 'ClinicalOptions', 'IcdNodes', 'ADL', 'Stats', 'Dashboard', 'Prescription', 'Rooms', 'MyRoom', 'Medicine', 'PrescriptionTemplate', 'FollowUp', 'PatientVisit', 'ChildCapWorkup', 'ChildPatient'],
  endpoints: (builder) => ({}),
});