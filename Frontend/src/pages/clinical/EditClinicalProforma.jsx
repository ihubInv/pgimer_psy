...
import { generateClinicalProformaPrintHtml } from '../../utils/clinicalProformaPrint';
...
const EditClinicalProforma = ({ initialData: propInitialData = null, onUpdate: propOnUpdate = null, onFormDataChange = null, hideFileUpload = false }) => {
  ...
  const clinicalProformaRowsForPatient = clinicalProformaRecordsOnly(patientProformas);
  const hasHistory = clinicalProformaRowsForPatient.length > 0;
  ...
  const initialFormData = useMemo(() => {
    ...
    if (propInitialData) {
      ...
      return {
        ...
        mse_thought: normalizeArrayField(propInitialData.mse_thought),
    ...
    const baseData = {
      ...
      mse_thought: normalizeArrayField(proforma.mse_thought),
  ...
  const handlePrintSection = (sectionName) => {
    ...
    printWindow.document.write(generateClinicalProformaPrintHtml(formData, patient, clinicalOptions));
    ...
    try {
      ...
      if (propInitialData && propOnUpdate) {
        const updateData = {
          ...
          mse_thought: join(currentFormData.mse_thought),
      ...
      const proformaData = {
        ...
        mse_thought: join(currentFormData.mse_thought) || null,
    ...
    <>
      ...
      {shouldShowHistory && (
        <PatientClinicalHistory
          patient={patient}
          visitHistory={[]}
          clinicalProformas={clinicalProformaRowsForPatient}
