          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Password Setup Successful!</h3>

                <p className="text-gray-600 mb-6">
                  Your password has been successfully set. Your account is now fully activated and you can log in to the system.
                </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading || passwordErrors.length > 0 || formData.newPassword !== formData.confirmPassword || !token}
