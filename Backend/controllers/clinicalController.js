    ...
    if (data.doctor_decision === "complex_case") {
      ...
      // Extract complex case fields (ADL-specific fields only)
          const complexCaseFields = [
            'history_present_illness', 'history_treatment_drugs', 'history_treatment_response',
            'informants', 'complaints_patient', 'complaints_informant',
            'past_history_medical', 'past_history_psychiatric',
            ...
            'mse_thought_flow', 'mse_thought_form', 'mse_thought_content', 'mse_thought_possession', 'mse_thought_perception',
            ...
            'education_history',
            'occupation_history', 'sexual_menarche_age', 'sexual_menarche_reaction', 'sexual_education', 'sexual_masturbation',
            'sexual_contact', 'sexual_premarital_extramarital', 'sexual_marriage_arranged', 'sexual_marriage_details',
            'sexual_children', 'religion_history',
            'living_situation_history', 'general_home_situation', 'personal_birth_date', 'personal_birth_place',
            'personal_delivery_type', 'personal_complications_prenatal', 'personal_complications_natal', 'personal_complications_postnatal',
            'development_history', 'final_assessment_history'
          ];
      ...
      try {
        // STEP 1: Create clinical_proforma (adl_file_id will be null initially)
          ...
          visit_type: data.visit_type || 'first_visit',
            ...
            informant_who: data.informant_who || null,
